...
本文将会介绍如何部署一台新的服务器。本文 4～6 节内容是关于服务器的安全配置，如果你只是想要部署一个简单的网站，阅读前 3 节即可
{% endnote %}
...
SSH 端口默认是 22，如果看过 SSH 登陆日志 你应该会发现，你的 SSH 每天都会被 **来自全球各地的大量的暴力破解** 密码尝试。这些攻击者会尝试使用常见的用户名和密码来登录你的服务器，如果你的密码不够复杂，那么你的服务器很有可能会被攻破。改变 SSH 端口理论上可以减少九九成以上的暴力破解尝试。
